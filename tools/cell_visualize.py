...
def main(format):
    ...
    try:
        ...
        genotype = Genotype(down=[('down_dil_conv', 0), ('down_dil_conv', 1), ('down_dep_conv', 0), ('dil_conv', 2), ('dil_conv', 2), ('dil_conv', 3)], down_concat=range(2, 5), up=[('conv', 0), ('up_dil_conv', 1), ('up_cweight', 1), ('dep_conv', 2), ('up_dil_conv', 1), ('identity', 0)], up_concat=range(2, 5), mid=[('conv', 0), ('up_dil_conv', 1), ('up_dil_conv', 1), ('cweight', 2), ('up_cweight', 1), ('identity', 2)], mid_concat=range(2, 5))
