...
def main(format):
    ...
    try:
        genotype = Genotype(down=[('dil_conv_3', 0), ('dil_conv_3', 1), ('dil_conv_3', 2), ('dil_conv_3', 1)], down_concat=range(2, 4), up=[('dil_conv_3', 0), ('dil_conv_3', 1), ('dil_conv_3', 0), ('dil_conv_3', 2)], up_concat=range(2, 4), gamma=[1, 1, 0, 1, 0, 1])
