...
def main(format):
    ...
    try:
        genotype = Genotype(down=[('dep_sep_conv_3', 0), ('dil_3_conv_5', 1), ('dil_3_conv_5', 1), ('dil_3_conv_5', 2)], down_concat=range(2, 4), up=[('dil_3_conv_5', 1), ('dil_3_conv_5', 0), ('dil_3_conv_5', 0), ('dil_3_conv_5', 2)], up_concat=range(2, 4), gamma=[1, 0, 1, 1, 1, 1])
