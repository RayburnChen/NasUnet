...
def main(format):
    ...
    try:
        genotype = Genotype(down=[('down_dil_conv', 0), ('down_dil_conv', 1), ('down_dil_conv', 1), ('dil_conv', 2), ('down_cweight', 1), ('dil_conv', 3), ('dil_conv', 4), ('dil_conv', 2)], down_concat=range(2, 6), up=[('dil_conv', 0), ('up_dil_conv', 1), ('shuffle_conv', 0), ('dil_conv', 2), ('dil_conv', 2), ('dil_conv', 3), ('dil_conv', 4), ('dil_conv', 2)], up_concat=range(2, 6), gamma=[0, 0, 0, 0, 0, 0])
