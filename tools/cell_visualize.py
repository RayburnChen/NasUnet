...
def main(format):
    ...
    try:
        genotype = Genotype(down=[('avg_pool', 0), ('down_dil_conv', 1), ('down_conv', 1), ('dil_conv', 2), ('dil_conv', 2), ('dil_conv', 3), ('identity', 3), ('dil_conv', 4)], down_concat=range(2, 6), up=[('conv', 0), ('up_dil_conv', 1), ('up_cweight', 1), ('dil_conv', 2), ('dil_conv', 2), ('dil_conv', 3), ('dil_conv', 2), ('dil_conv', 4)], up_concat=range(2, 6))
