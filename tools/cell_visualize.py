...
def main(format):
    ...
    try:
        genotype = Genotype(down=[('down_dep_conv', 0), ('down_dep_conv', 1), ('max_pool', 1), ('dil_conv', 2), ('down_dep_conv', 1), ('dil_conv', 3)], down_concat=range(2, 5), up=[('dil_conv', 0), ('up_dil_conv', 1), ('dil_conv', 0), ('cweight', 2), ('conv', 3), ('dep_conv', 2)], up_concat=range(2, 5))
