...
def main(format):
    ...
    try:
        genotype = Genotype(down=[('down_dil_conv', 0), ('down_dil_conv', 1), ('down_dil_conv', 1), ('dil_conv', 2), ('down_dep_conv', 1), ('dil_conv', 2)], down_concat=range(2, 5), up=[('identity', 0), ('up_dil_conv', 1), ('dil_conv', 2), ('up_cweight', 1), ('up_dil_conv', 1), ('dil_conv', 2)], up_concat=range(2, 5), mid=[('dep_conv', 0), ('up_cweight', 1), ('up_dil_conv', 1), ('cweight', 2), ('up_dep_conv', 1), ('dep_conv', 3)], mid_concat=range(2, 5))
    ...
    mid_cell_name = '{}-{}'.format("MidC", datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
    ...
    visualize.plot(genotype.mid, mid_cell_name, format=format, directory="./cell_visualize")
