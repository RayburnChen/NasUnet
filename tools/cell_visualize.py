...
def main(format):
    ...
    try:
        genotype = Genotype(down=[('max_pool', 1), ('down_dil_conv', 0), ('dil_conv', 2), ('down_cweight', 1), ('shuffle_conv', 2), ('dep_conv', 3)], down_concat=range(2, 5), up=[('dil_conv', 0), ('up_dep_conv', 1), ('up_conv', 1), ('conv', 2), ('conv', 2), ('shuffle_conv', 3)], up_concat=range(2, 5))
